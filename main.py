...
class NeuralNetworkVisualizer:
    ...
    def setup_control_panel(self):
        ...
        ttk.Combobox(self.control_frame, textvariable=self.dataset_var,
                     values=["XOR", "AND", "OR", "NAND", "NOR", "XNOR", "Circles", "Moons", "Iris","Iris-3Class","Custom"], state="readonly").pack(fill=tk.X, padx=5)
    ...
    def change_dataset(self, *args):
        ...
        try:
            if dataset == "Custom":
                ...
                elif dataset == "Iris-3Class":
                    self.X = np.array([
                        [0.22, 0.62, 0.07, 0.04],  # Class 0
                        [0.44, 0.54, 0.23, 0.10],
                        [0.36, 0.50, 0.18, 0.08],
                        [0.61, 0.58, 0.45, 0.25],  # Class 1
                        [0.67, 0.69, 0.56, 0.29],
                        [0.56, 0.50, 0.40, 0.25],
                        [0.75, 0.73, 0.63, 0.33],  # Class 2
                        [0.64, 0.62, 0.49, 0.30],
                        [0.78, 0.80, 0.70, 0.38],
                        [0.72, 0.76, 0.68, 0.36],
                    ])
